                ...
                <div class="row">
                    <div class="col-md-6 pull-right">
                        <div class="content-portfolio-box">
                            <h2> GIFTS PUBLICITAIRES /GOODIES PUBLICITAIRES</h2>
                            <p>
                        ...
                        <div class="info-portfolio-box">
                            ...
                            <img src="../assets/images/cart/gifts.png" alt="">
                            ...
                            <li>
                                <a href="">
                                    ...
                                    <div style="top: 32%;" class="text-middle banner-center hover-style-7">
                                        <div class="thumb">
                                            <p class="text-middle1">Stylos</p>
                                            <p class="text-middle1">Portes clés</p>
                            ...
                            <li>
                                <a href="">
                                    ...
                                    <div style="top: 57%;" class="text-middle banner-center hover-style-7">
                                        <div class="thumb">
                                            <p class="text-middle1">Clés USB</p>
                                            <p class="text-middle1">Power bank</p>
                            ...
                            <li>
                                <a href="">
                                    ...
                                    <div style="top: 82%;" class="text-middle banner-center hover-style-7">
                                        <div class="thumb">
                                            <p class="text-middle1">Trophées</p>
                                            <p class="text-middle1">Parasols</p>
