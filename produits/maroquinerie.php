                ...
                <div class="row">
                    <div class="col-md-6 pull-right">
                        <div class="content-portfolio-box">
                            <h2> MAROQUINERIE ET PETITE MAROQUINERIE</h2>
                            <p>
                        ...
                        <div class="info-portfolio-box">
                            ...
                            <img src="../assets/images/cart/maroquinerie.png" alt="">
                            ...
                            <li>
                                <a href="">
                                    ...
                                    <div class="text-middle banner-center hover-style-7">
                                        <div class="thumb">
                                            <p class="text-middle1">Cartables</p>
                                            <p class="text-middle1">Sacs conférences</p>
                            ...
                            <li>
                                <a href="">
                                    ...
                                    <div style="top: 32%;" class="text-middle banner-center hover-style-7">
                                        <div class="thumb">
                                            <p class="text-middle1">Porte monnaie</p>
                                            <p class="text-middle1">Porte carte de crédit</p>
                            ...
                            <li>
                                <a href="">
                                    ...
                                    <div style="top: 57%;" class="text-middle banner-center hover-style-7">
                                        <div class="thumb">
                                            <p class="text-middle1">Portefeuille</p>
                                            <p class="text-middle1">Porte chéquier</p>
